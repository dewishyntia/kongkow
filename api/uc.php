...
define('UC_CLIENT_VERSION', '1.5.0');	//note UCenter version identifier
define('UC_CLIENT_RELEASE', '20081031');

define('API_DELETEUSER', 1);		//note delete user API interface switch
define('API_RENAMEUSER', 1);		//note renamed user API interface switch
define('API_GETTAG', 1);		//note Being tag API Interface Switch
define('API_SYNLOGIN', 1);		//note synchronization Login API Interface Switch
define('API_SYNLOGOUT', 1);		// note synchronization Listings API Interface Switch
define('API_UPDATEPW', 1);		//note change user passwords switch
define('API_UPDATEBADWORDS', 1);	//note updating your keyword list switch
define('API_UPDATEHOSTS', 1);		//note update DNS cache switch
define('API_UPDATEAPPS', 1);		//note updates the application list switch
define('API_UPDATECLIENT', 1);		//note update client cache switch
define('API_UPDATECREDIT', 1);		//note updates the user integral switch
define('API_GETCREDITSETTINGS', 1);	// note to provide integration UCenter setting switch
define('API_GETCREDIT', 1);		//note Being an integral switch users
define('API_UPDATECREDITSETTINGS', 1);	//note updating application integration settings switch
...
// Note before using this function requires
...
function data_auth_sign($data)
{
    ...
    ksort($data); // sort
    $code = http_build_query($data); // url encoded and generate query strings
    $sign = sha1($code); // generate the signature
    return $sign;
}
